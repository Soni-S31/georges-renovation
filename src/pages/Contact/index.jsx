  ...
  return (
    ...
    <div className="intro">
      <div className='content_intro'>
        ...
        Contactez-nous dès maintenant en nous décrivant votre projet et nous vous recontacterons : <a className="lien_contact" href="mailto:georges.renovation31@gmail.com"> ici</a> 
        </div>
        <div className='content_intro'>
          <h2>Coordonnées</h2>
          <p>Adresse : Georges Rénovation </p><p>24 rue Bernadette - 31100 Toulouse</p>
      <p>Téléphone : <a className="lien_contact" href="tel:+0695975085">06 95 97 50 85 </a></p>
      <p>Email : <a className="lien_contact"href="mailto:georges.renovation31@gmail.com">georges.renovation31@gmail.com</a></p>
        </div>
