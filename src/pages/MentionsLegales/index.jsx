...
const MentionsLegales = () => {
  return (
    <div>
      ...
      <h2>Coordonnées du professionnel</h2>
      ...
      <p>Numéro de TVA : FR30898572698</p>

      <h2>Responsable de la publication</h2>
          <p>Nom du responsable de la publication : Soni Développement à Toulouse</p>
    ...
    <h2>Conservation et protections des données</h2>
